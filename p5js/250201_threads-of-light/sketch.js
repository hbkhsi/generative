...
const colorPalettes = [
  ...
  ["#000000", "#1A1A1A", "#333333", "#666666", "#999999"], // モノクロ（黒→グレー）
  ["#FFFFFF", "#E6E6E6", "#CCCCCC", "#B3B3B3", "#999999"], // モノクロ（白→グレー）
  ["#2C3639", "#3F4E4F", "#A27B5C", "#DCD7C9", "#FFFFFF"], // コーヒートーン
  ["#FF9F1C", "#FFBF69", "#CBF3F0", "#2EC4B6", "#FFFFFF"], // トロピカル
  ["#22577A", "#38A3A5", "#57CC99", "#80ED99", "#C7F9CC"], // 深い海
  ["#FFBE0B", "#FB5607", "#FF006E", "#8338EC", "#3A86FF"], // ビビッドカラー
  ["#F1EEF7", "#8796B6", "#34496D", "#000000", "#FFFFFF"], // モノクロ
];
